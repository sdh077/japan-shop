...
<script lang="ts">
	...
	export let defaultClass: string = 'form-control';
	export let extraClass: string = 'mb-2';
	...
	const inputPadding = { sm: 'form-control-sm', md: 'form-control-md', lg: 'form-control-lg' };
