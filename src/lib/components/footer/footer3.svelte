		...
		<div class="row grid-separator align-items-stretch">
			...
			<div class="col-md-7 col-lg-4 pe-md-6 py-lg-11 py-9">
				<div class="d-flex flex-column h-100">
					<h6 class="mb-4 text-white-50">Join our mail list</h6>
					<p class="mb-4 small text-white-50">
						Join us today and get 20% off on your first purchase
					</p>
					<form novalidate class="needs-validation">
						...
						<div class="mb-3">
							<p class="small text-white-50 mb-0">
								By clicking on Sign me up, you agree to our <a
									class="fw-semibold d-table link-light"
					...
					<div class="d-inline-flex align-items-center dropup mt-6">
						<button
							class="btn border text-body py-1 px-3 dropdown-toggle d-flex align-items-center"
							id="assan-theme"
							type="button"
							aria-expanded="false"
						...
						>
							<span class="theme-icon-active d-flex align-items-center">
								<small>Current theme</small> <i class="bx align-middle ms-2" />
							</span>
						</button>
						<!--:Dark Mode Options:-->
						<ul
			...
			<div class="col-md-5 col-lg-3 ps-md-6 py-lg-11 py-9">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a href="#" class="nav-link"> Comapny </a>
					</li>
					<li class="nav-item">
			...
			<div class="col-md-12 col-lg-5 ps-md-6 py-lg-11 py-9">
				<div class="d-flex flex-column flex-sm-row">
					...
					<div class="ps-sm-3 flex-grow-1">
						...
						<p class="text-white">Office opening hours are 10.00am to 6.00pm</p>
						<hr />
						...
						<a href="mailto:mail@email.com" class="fw-semibold link-underline link-light"
							>mail@domain.com</a
						>
					</div>
				</div>
