<script>
	...
	onMount(() => {
		...
		var officeLocation = [126.9117266, 37.5903122];
...
<main class="main-content" id="main-content">
		...
		<div class="container position-relative pt-12 pt-lg-15">
			<div class="row">
				<div class="col-lg-8 col-md-10">
					<h1 class="display-2 mb-3">Get in touch with us</h1>
					<p class="mb-7 pe-lg-9 lead">
						Do you have questions about our products or need a quote? Use the contact form below and
						we will get back to you.
					</p>
				</div>
			</div>
			<!--/.row-->
			<img src="/img/1200x600/2.jpg" class="img-fluid rounded-block" alt="" />
		</div>
		<!--/.content-->
	</section>
	<!--/section-->
		...
		<div class="container py-9 py-lg-11">
			<div class="row mb-9 mb-lg-11">
				<div class="col-lg-4 mb-5 mb-lg-0 text-center">
					...
					<p class="mb-3 small">
						If you are already a customer with us, we will be happy to help you in our Customer
						Support.
					</p>
					<a href="mailto:youremail.com" class="btn btn-sm btn-light shadow-sm">
						<i class="bx bx-headphone align-middle fw-normal me-1" /> Customer support
					</a>
				</div>
				...
				<div class="col-lg-4 mb-5 mb-lg-0 text-center">
					...
					<a href="#" class="btn text-lowercase btn-sm btn-light shadow-sm">
						<i class="bx bxl-skype align-middle fw-normal me-1" /> rakesh.sharma856
					</a>
				</div>
				<div class="col-lg-4 text-center">
					...
					<a href="#!" class="btn btn-sm btn-light shadow-sm">
						<i class="bx bx-phone align-middle fw-normal me-1" /> +01 1234-567-890
					</a>
				</div>
			</div>
				...
				<div class="col-md-10 col-lg-8 mx-auto">
					<div class="position-relative">
						...
						<p class="mb-3 lead w-lg-75">
							Use the contact form if you have questions about our products. Our sales team will be
							happy to help you:
						</p>
						<div class="width-7x pt-1 bg-primary mb-7" />
						<!-- Contacts Form -->
						<form
							action="#"
							method="post"
						...
						>
							...
							<div class="d-md-flex justify-content-md-between align-items-center">
								<p class="small mb-4 text-body-secondary mb-md-0">
	...
	<section>
		<div class="container pb-9">
			<div
				class="px-4 rounded-3 shadow-lg py-6 px-lg-5 py-lg-7 bg-primary text-white position-relative overflow-hidden"
				data-aos="fade-up"
			>
				<svg
					class="position-absolute end-0 bottom-0 mb-4 text-success"
					width="200"
					height="400"
				...
				<div class="row align-items-end position-relative">
					<div class="col-lg-7 text-center text-lg-start">
						...
						<h1 class="mb-5 mb-lg-0">Stunning websites ease</h1>
					</div>
					<div class="col-lg-5 text-lg-end text-center">
						<a href="#!" class="btn btn-outline-white btn-lg rounded-3 me-2 mb-2 mb-lg-0"
							>Contact sales</a
						>
